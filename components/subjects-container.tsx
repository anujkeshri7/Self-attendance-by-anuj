    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <span className="text-2xl">{template ? getCategoryIcon(template.category) : "📁"}</span>
          <h2 className="text-2xl font-semibold text-gray-800">{template ? template.name : "All Subjects"}</h2>
        </div>
        <div className="flex items-center space-x-2">
          {template && (
            <Button variant="ghost" size="sm" onClick={onRenameTemplate} className="text-gray-600">
